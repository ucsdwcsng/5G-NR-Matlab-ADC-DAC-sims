...
rxWaveform_ADC_decim = lowpass(rxWaveform_ADC_Samples_combined,0.2);
...
rxWaveform_DBF = resample(rxWaveform_GMO,1,4);
% 
...
if(enable_artificial_cfo)
    ...
    rxWaveform_DBF = rxWaveform_DBF.*transpose(exp(-1i*2*pi*f_offset*(0:length(rxWaveform_DBF)-1)));
end
...
[evmInfo,eqSym,refSym,hest,pilot_indices] = hNRPUSCHEVM(cfgUL,rxWaveform_DBF,cfg);
