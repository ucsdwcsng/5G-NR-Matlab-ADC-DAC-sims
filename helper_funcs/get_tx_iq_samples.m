function [tx_iqsamples,simParameters,waveformParams] = get_tx_iq_samples(num_slots_to_gen,SCS,grid_size,num_layers,num_tx_ant,num_rx_ant,num_zeros_to_append,num_zeros_to_prepend)
    if(nargin==6)
    ...
    for nslot = 0:NSlots-1
        ...
        simParameters.txslotsize_samples = numel(txWaveform);
    ...
    tx_iqsamples = 0.8*(tx_iqsamples/max(abs(tx_iqsamples)));
